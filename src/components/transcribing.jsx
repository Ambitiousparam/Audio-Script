...
export default function Transcribing(props) {
    ...
    return (
        <div className='flex items-center flex-1 flex-col justify-center gap-10 md:gap-14 text-center pb-24 p-4 pb'>
            ...
            <div className='flex flex-col gap-2 sm:gap-3 max-w-[600px] mx-auto w-full'>
                {[0, 1, 2].map(val => (
